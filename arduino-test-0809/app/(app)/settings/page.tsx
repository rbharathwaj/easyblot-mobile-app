...
export default function SettingsPage() {
  ...
  return (
    <Page>
      ...
      {/* ---- DEVELOPMENT ONLY: remove with app/dev/ and lib/easyblotDevice.ts ---- */}
      <Item>
        <div className="eyebrow">Development</div>
        <Card>
          <div className="row">
            <div className="grow">
              <div className="name">ESP32 Connectivity Test</div>
              <div className="meta">Hardware bring-up: blink a board&apos;s LED over local Wi-Fi</div>
            </div>
            <Link href="/dev/esp32"><Btn size="sm" variant="ghost">Open</Btn></Link>
          </div>
        </Card>
      </Item>
